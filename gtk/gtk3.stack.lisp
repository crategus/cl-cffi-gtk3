...
(defcfun ("gtk_stack_get_child_by_name" stack-child-by-name)
         (g:object widget)
 #+liber-documentation
 "@version{#2021-12-7}
  @argument[stack]{a @class{gtk:stack} widget}
...
(defcfun ("gtk_stack_set_visible_child_full" stack-set-visible-child-full)
    :void
 #+liber-documentation
 "@version{#2021-12-7}
  @argument[stack]{a @class{gtk:stack} widget}
