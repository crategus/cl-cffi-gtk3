...
#+liber-documentation
(setf (documentation (liber:slot-documentation "embedded" 'gtk-status-icon) t)
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-embedded)
      "Accessor"
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "file" 'gtk-status-icon) t)
 "The @code{file} property of type @code{:string} (Write) @br{}
  Filename to load and display. @br{}
  Default value: @code{nil}")

#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-file)
      "Accessor"
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "gicon" 'gtk-status-icon) t)
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-gicon)
      "Accessor"
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-has-tooltip)
      "Accessor"
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "icon-name" 'gtk-status-icon) t)
 "The @code{icon-name} property of type @code{:string} (Read / Write) @br{}
  The name of the icon from the icon theme. @br{}
  Default value: @code{nil}")

#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-icon-name)
      "Accessor"
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-orientation)
      "Accessor"
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "pixbuf" 'gtk-status-icon) t)
 "The @code{pixbuf} property of type @class{gdk:pixbuf} (Read / Write) @br{}
  The pixbuf to display.")

#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-pixbuf)
      "Accessor"
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "screen" 'gtk-status-icon) t)
 "The @code{screen} property of type @class{gdk-screen} (Read / Write) @br{}
  The screen where this status icon will be displayed.")

#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-screen)
      "Accessor"
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "size" 'gtk-status-icon) t)
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-size)
      "Accessor"
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "stock" 'gtk-status-icon) t)
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-stock)
      "Accessor"
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-storage-type)
      "Accessor"
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "title" 'gtk-status-icon) t)
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-title)
      "Accessor"
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-tooltip-markup)
      "Accessor"
...
#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-tooltip-text)
      "Accessor"
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "visible" 'gtk-status-icon) t)
 "The @code{visible} property of type @code{:boolean} (Read / Write) @br{}
  Whether the status icon is visible. @br{}
  Default value: @em{true}")

#+liber-documentation
(setf (liber:alias-for-function 'gtk-status-icon-visible)
      "Accessor"
