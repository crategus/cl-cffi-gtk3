...
(defcfun ("gtk_icon_factory_lookup" icon-factory-lookup)
...
(defcfun ("gtk_icon_factory_remove_default" icon-factory-remove-default)
    :void
 #+liber-documentation
 "@version{#2021-7-21}
...
(defcfun ("gtk_icon_source_new" icon-source-new)
    (g:boxed icon-source)
 #+liber-documentation
 "@version{#2021-7-21}
