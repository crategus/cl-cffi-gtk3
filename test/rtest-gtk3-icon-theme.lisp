...
(test icon-theme-load-icon-for-scale
  (let ((theme (gtk:icon-theme-default)))
...
(test icon-theme-example-icon-name
  (let ((theme (gtk:icon-theme-default)))
    #-windows
    (is (string= "folder"
...
(test icon-theme-resan-if-needed
  (let ((theme (gtk:icon-theme-default)))
