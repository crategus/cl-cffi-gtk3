...
(test gtk-drag-source-add-image-targets
  (let ((source (make-instance 'gtk:button)))
    ...
    (is (equal '(("image/png" NIL 0) ("image/jpeg" NIL 0)
                 ("image/avif" NIL 0)
                 ("image/bmp" NIL 0)
                 ("image/x-bmp" NIL 0) ("image/x-MS-bmp" NIL 0)
                 ("image/x-icon" NIL 0)
                 ("image/x-ico" NIL 0) ("image/x-win-bitmap" NIL 0)
                 ("image/vnd.microsoft.icon" NIL 0) ("application/ico" NIL 0)
                 ("image/ico" NIL 0) ("image/icon" NIL 0) ("text/ico" NIL 0)
                 ("image/tiff" NIL 0) ("image/webp" NIL 0)
                 ("audio/x-riff" NIL 0))
               (gtk:target-table-new-from-list
                   (gtk:drag-source-target-list source))))))
