...
(test gtk-button-new-with-mnemonic
  (glib-test:with-check-memory (button)
    (is (typep (setf button (gtk:button-new-with-mnemonic "_Mnemonic")) 'gtk:button))
    (is-false (gtk:button-always-show-image button))
    (is-false (gtk:button-image button))
    (is (eq :left (gtk:button-image-position button)))
...
(test gtk-button-new-from-icon-name
  (glib-test:with-check-memory (button)
    (is (typep (setf button
                     (gtk:button-new-from-icon-name "edit-copy" :button)) 'gtk:button))
    (is-false (gtk:button-always-show-image button))
    ...
    (is-false (setf (gtk:button-image button) nil))))
...
(test gtk-button-event-window
  (glib-test:with-check-memory (window button)
    ...
    (is (typep (setf button
                     (gtk:button-new-from-icon-name "gtk-close" :button)) 'gtk:button))
