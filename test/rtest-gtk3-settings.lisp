...
(test im-preedit-style
  ...
  (is (equal '("GTK_IM_PREEDIT_NOTHING" "GTK_IM_PREEDIT_CALLBACK"
               "GTK_IM_PREEDIT_NONE")
             (list-enum-item-name "GtkIMPreeditStyle")))
  ;; Check the values
  (is (equal '(0 1 2)
             (list-enum-item-value "GtkIMPreeditStyle")))
  ...
  (is (equal '(DEFINE-G-ENUM "GtkIMPreeditStyle" GTK-I-M-PREEDIT-STYLE
                             ...
                             (:CALLBACK 1)
                             (:NONE 2))
             (gobject:get-g-type-definition "GtkIMPreeditStyle"))))

;;;     GtkIMStatusStyle

(test im-status-style
  ;; Check the type
  ...
  (is (equal '("GTK_IM_STATUS_NOTHING" "GTK_IM_STATUS_CALLBACK"
               "GTK_IM_STATUS_NONE")
             (list-enum-item-name "GtkIMStatusStyle")))
  ;; Check the values
  (is (equal '(0 1 2)
             (list-enum-item-value "GtkIMStatusStyle")))
  ;; Check the nick names
  (is (equal '("nothing" "callback" "none")
  ...
  (is (equal '(DEFINE-G-ENUM "GtkIMStatusStyle" GTK-I-M-STATUS-STYLE
                             ...
                             (:CALLBACK 1)
                             (:NONE 2))
             (gobject:get-g-type-definition "GtkIMStatusStyle"))))
